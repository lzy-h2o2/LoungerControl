...
public class Advice_Delet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (lrkz_service.Delete_advice(uid).equals("ok")) {
			response.sendRedirect("message1.jsp");
		}else {
			//JOptionPane.showMessageDialog(null,"反馈删除失败","提示", JOptionPane.WARNING_MESSAGE);
